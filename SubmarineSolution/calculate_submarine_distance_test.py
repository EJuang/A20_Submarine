...
class ProcessCourseTest(unittest.TestCase):
    ...
    def test_raise_error_for_negative_course_instruction_value(self):
        testValues = [
            ('forward', '5'),
            ('down', '-1')
        ]
    ...
    def test_raise_error_for_nonnumerical_course_instruction_value(self):
        testValues = [
            ('forward', '5'),
            ('down', 'six')
        ]
    ...
    def test_raise_error_for_no_course_instruction_value(self):
        testValues = [
            ('forward', '5'),
            ('down')
        ]
    ...
    def test_raise_error_for_invalid_course_instruction_type(self):
        testValues = [
            ('forward', '5'),
            ('dive', '6')
        ]
